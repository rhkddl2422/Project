...
<li><a href="/tabi/session/login">로그인</a></li><li><a href="/mybatis/insertmember">회원가입</a></li></ul></div></div>
</header>
<div class="wrap"><h1>상품리스트</h1></div>
<hr>
<section class="content">
 <div class="lists"><ul>
<%@ taglib prefix="c"  uri="http://java.sun.com/jsp/jstl/core" %>
<c:forEach items="${list}"   var="vo">
    <li><a href="/tabi/mybatis/boardetail?seq=${vo.seq}">상품명 : ${vo.t_name}<br> bookdata : ${vo.bookdate}</a></li>
</c:forEach> 
</ul></div>
</section>
