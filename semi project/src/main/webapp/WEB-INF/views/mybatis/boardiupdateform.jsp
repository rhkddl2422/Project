...
<div class="wrap"><h1>상품수정</h1></div>
<hr>
<section class="add">
<div class="wrap">

<form action="http://localhost:8080/tabi/mybatis/updateticket" method="post">
 <label>상품명 : </label><input type=text name="t_name" maxlength="10" value="${ticket.t_name}"><br>
 
 <label>상품내용 : </label><textarea name="contents" rows=10 cols="50">
      ${ticket.contents}</textarea> <br>
<label>가격 : </label><input type=text name="price" value="${ticket.price}"><br>
<label>남은기간 : </label><input type="text" name="bookdate"  value="${ticket.bookdate}"><br>
<label>계좌번호 : </label><input type="text" name="account" value="${ticket.account}"><br>
<input type="hidden" name="seq" value="${ticket.seq}">
